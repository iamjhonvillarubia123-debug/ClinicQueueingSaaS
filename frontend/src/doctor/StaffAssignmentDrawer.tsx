...
export function StaffAssignmentDrawer({
  ...
  const [role, setRole] = useState<
    'CLINIC_SECRETARY' | 'SUBSTITUTE_SECRETARY'
  >('CLINIC_SECRETARY');
      ...
      {step === 1 ? (
        <>
          ...
          >
            ...
            <span>Assign a Secretary who already has an account in the system.</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span>Send a clinic invitation to an existing Secretary account.</span>
          </button>
        </>
      ) : null}
      ...
      {step === 3 ? (
        <>
          ...
          >
            ...
            <span>
              Temporary coverage with live clinic and queue authority only during
              covered dates.
            </span>
          </button>
        </>
      ...
      {step === 4 && role === 'CLINIC_SECRETARY' ? (
        <>
          ...
          <label className="staff-radio">
            ...
            <small>Sensitive authority requiring Doctor re-authentication when used.</small>
          </label>
          {current ? (
            ...
            <div className="staff-replacement-warning">
              ...
              <p>
                Cancel Clinic Day can interrupt clinic operations and requires fresh
                Doctor authentication before it is granted.
              </p>
              <label>
      ...
      {step === 4 && role === 'SUBSTITUTE_SECRETARY' ? (
        <>
          ...
          <div className="staff-neutral-note">
            Authority is fixed and limited to live clinic and queue operations on
            covered Clinic Days. The Clinic Secretary remains assigned.
          </div>
        </>
      ) : null}
              ...
              <div>
                ...
                <dd>
                  {bundles
                    .map(
                      (bundle) =>
                        AUTHORITY_BUNDLES.find(([value]) => value === bundle)?.[1],
                    )
                    .join(', ')}
                </dd>
              </div>
