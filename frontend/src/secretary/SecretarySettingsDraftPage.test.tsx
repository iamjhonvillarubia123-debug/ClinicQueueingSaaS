...
describe('SecretarySettingsDraftPage', () => {
  ...
  it('persists service drag order as presentation-only displayOrder proposals', async () => {
    ...
    expect(servicePanel).not.toBeNull();
    const serviceList = servicePanel!.querySelector('.proposal-sort-list');
  ...
  it('persists booking-question drag order through displayOrder without exposing the field', async () => {
    ...
    const questionList = questionPanel!.querySelector('.proposal-sort-list');
