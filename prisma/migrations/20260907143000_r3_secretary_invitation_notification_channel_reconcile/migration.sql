-- R3 Secretary invitation notification channel reconciliation.
-- Restore the canonical NotificationOutbox channel/type matrix after local database drift.
-- SECRETARY_INVITATION remains EMAIL-only. This intentionally does not broaden
-- the approved invitation notification channel to SMS.
