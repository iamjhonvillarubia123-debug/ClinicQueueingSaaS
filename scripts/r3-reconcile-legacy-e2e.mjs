...
const startContents = readFileSync(startPath, 'utf8');
if (startContents.includes("  let regularSecretaryUserId: string;\n")) {
  replaceRequired(
    startPath,
...
const cancelContents = readFileSync(cancelPath, 'utf8');
if (!cancelContents.includes("bundleType: 'APPOINTMENTS_AND_PATIENT_INTAKE'")) {
  replaceRequired(
    cancelPath,
